...
const Overview = () => {
  ...
  // Mock cashflow history for line chart
  const cashflowHistory = [
    { name: 'Apr', Income: totalIncome * 0.9, Expenses: totalOutflow * 0.95 },
    { name: 'May', Income: totalIncome * 0.95, Expenses: totalOutflow * 0.98 },
    { name: 'Jun', Income: totalIncome * 1.05, Expenses: totalOutflow * 1.02 },
    { name: 'Jul', Income: totalIncome * 0.98, Expenses: totalOutflow * 1.05 },
    { name: 'Aug', Income: totalIncome * 1.02, Expenses: totalOutflow * 0.99 },
    { name: 'Sep', Income: totalIncome, Expenses: totalOutflow },
  ];
